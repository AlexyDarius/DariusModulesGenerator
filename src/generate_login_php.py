def generate_login_php(directory_path, modules_index_title, full_body_tag, main_domain):
...
?>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form id="loginForm" action="https://www.{main_domain}/modules/auth/auth.php" class="text-center" method="post">
    ...
    <script src="https://www.{main_domain}/js/bootstrap.min.js"></script>
...
'''
    ...
    with open(f"{directory_path}/modules/login.php", "w") as php_file:
